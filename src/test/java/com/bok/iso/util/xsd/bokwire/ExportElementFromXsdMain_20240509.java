...
public class ExportElementFromXsdMain_20240509 {

	public static void main(String[] args) {
		
		String inputDirStr = "C:\\Users\\bok\\git\\bok\\bokworks-generate-xml\\src\\main\\resources\\static\\input\\bokwire\\20240404";
		String outputDirStr = "C:\\Users\\bok\\git\\bok\\bokworks-generate-xml\\src\\main\\resources\\static\\output\\bokwire\\20240509";
		...
		try {
			...
			File [] files = inputDir.listFiles(new FilenameFilter() {
				...
				public boolean accept(File dir, String name) {
					if ( name.contains("pacs_009") && name.contains("CORE") ) 
						return true;
					return false;
				}
			});
			...
			for ( File f : files ) {
				...
				if ( f.getName().contains("bah")) {
					...
					xsdToElement = new ParseXsdToElement(f, "Document", "urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08");
					xsdToElement.doWork();
					gen2 = new GenerateElementSize2();
